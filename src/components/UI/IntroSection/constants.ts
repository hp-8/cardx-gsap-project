...
// For desktop
export const desktopHeaderPhrase = ["Introducing CARDx's Next-", 'Gen Cards'];
export const desktopParagraphPhrase = [
  " Discover CARDx's latest innovation – our new cards. Elevate your banking",
  'experience with cutting-edge features, security, and unprecedented',
  'convenience.',
];

// For mobile
export const mobileHeaderPhrase = ["Introducing CARDx's", 'Next-Gen Cards'];
export const mobileParagraphPhrase = [
  " Discover CARDx's latest innovation – our new cards.",
